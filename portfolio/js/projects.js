this.projects = [{
    ...
    description: "Big band Jazz Orchestra. <br> This responsive website required complex UI/UX components and subtle animations. <br>All done with plain and pure CSS, no framework.",
    ...
    name: "Unplace Museum",
    description: "This project was for one of the biggest Modern Art institutions in Portugal (Fundação Calouste Gulbenkian).<br> The project was for a temporary international exhibition of world-wide modern artists. Site required inovative design and simple CMS support. <br>Extensive use of plain vanilla Javascript.",
    image: "unplace.jpg",
    // image: "300x200.png",
    url: {
    ...
    name: "Santinho",
    description: "Proof of concept for a religious institution. <br>Features inovative UI/UX components.",
    image: "santinho.jpg",
    // image: "300x200.png",
    url: {
    ...
    description: "Web portfolio of Portguese modern art artist Alexandre Camarão.<br> This website uses the flat file CMS framework: GRAV.",
    ...
    name: "AFSO",
    description: "Website for Portguese ONG, AFSO. <br>This website uses the flat file CMS framework: GRAV.",
    image: "afso.jpg",
    // image: "300x200.png",
    url: {
    ...
    name: "Alphalink",
    description: "Civil Engineer company.<br> A simple website to display the company portfolio.<br> This website uses the flat file CMS framework: GRAV.",
    image: "alphalink.jpg",
    // image: "300x200.png",
    url: {
    ...
    description: "My own website. <br>This responsive single-page website features some simple animations.",
    ...
    name: "SCA",
    description: "Proof of concept for SCA, a customer I've worked for. They requested me a POC for them to show to their stake-holders. <br>Very simple Bootstrap prototype.",
    image: "sca.jpg",
    // image: "300x200.png",
    url: {
